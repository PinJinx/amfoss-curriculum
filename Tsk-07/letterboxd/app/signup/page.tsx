...
export default function MainPage() {
  return (
    <div className="w-full h-screen">
      ...
      <h2 className="font-bold text-2xl pt-1 fixed top-24 ds:hidden text-white inset-x-0 text-center">
        Track, Save & Share Films
      </h2>
...
function SignInOrUp() {
  return (
    <div>
      <div className="w-[55rem] h-[35rem] bg-white rounded-3xl  shadow-lg ph:hidden flex items-center justify-center">
      ...
      {/* Phone Display */}
      <div className="w-[20rem] h-[24rem] bg-white rounded shadow-lg ds:hidden">
        <form className="flex w-full h-full flex-col items-center">
          <h1 className="font-bold text-4xl mt-5 mb-5">Register</h1>
          <input placeholder="  Enter Email" className="bg-white shadow-md rounded border w-[14rem] h-10 mb-4" />
            <input placeholder="  Enter Password" className="bg-white shadow-md rounded border w-[14rem] h-10 mb-4" />
            <input placeholder="  ReEnter Password" className="bg-white shadow-md rounded border w-[14rem] h-10 mb-[2rem]" />
            <button className="bg-cyan-800 text-white font-bold shadow-md w-20 rounded h-10 mb-6" >SignUp</button>
            <Link href="/"><h1>or login to an existing account</h1></Link>
        </form>
      </div>
    </div>
  );
